...
class Decl(Node):
    def __init__(self, typename, name, coord=None):
        self.name = name
...
class FuncDecl(Node):
    def __init__(self, name, type ,args, coord=None):
        self.args = args
        self.type = type
        self.name = name
        self.coord = coord
...
class FuncDef(Node):
    def __init__(self, decl, body, coord=None):
        self.decl = decl
        self.body = body
        self.coord = coord
    ...
    def children(self):
        ...
        for i, child in enumerate(self.decl.args or []):
